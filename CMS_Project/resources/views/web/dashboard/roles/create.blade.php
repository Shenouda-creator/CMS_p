                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card border-0 shadow-lg" style="border-radius: 2rem; background: linear-gradient(120deg, #f8fafc 70%, #e0e7ff 100%);">
                            <div class="card-body p-5">
                                <h2 class="fw-bold mb-4 text-center" style="letter-spacing: 1px; color: #222;">
                                    <span>
                                        <i class="bi bi-shield-lock"></i> Create New Role
                                    </span>
                                </h2>
                        ...
                        <div class="text-center mt-4">
                            <span class="text-muted small" style="color: #222 !important;">Assign permissions to the new role for better access control.</span>
                        </div>
                    </div>
                </div>
            </div>
