...
<html lang="en">
  <head>
    ...
    <!-- Simple bar CSS -->
    <link rel="stylesheet" href={{asset("site/css/simplebar.css")}}>
    <!-- Fonts CSS -->
    <link href="https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100;0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    <!-- Icons CSS -->
    <link rel="stylesheet" href={{asset("site/css/feather.css")}}>
    <link rel="stylesheet" href={{asset("site/css/select2.css")}}>
    <link rel="stylesheet" href={{asset("site/css/dropzone.css")}}>
    <link rel="stylesheet" href={{asset("site/css/uppy.min.css")}}>
    <link rel="stylesheet" href={{asset("site/css/jquery.steps.css")}}>
    <link rel="stylesheet" href={{asset("site/css/jquery.timepicker.css")}}>
    <link rel="stylesheet" href={{asset("site/css/quill.snow.css")}}>
    <!-- Date Range Picker CSS -->
    <link rel="stylesheet" href={{asset("site/css/daterangepicker.css")}}>
    <!-- App CSS -->
    <link rel="stylesheet" href={{asset("site/css/app-light.css")}} id="lightTheme">
    <link rel="stylesheet" href={{asset("site/css/app-dark.css" )}}id="darkTheme" disabled>
  </head>
  ...
  <body class="vertical  light  ">
    ...
    <script src={{ asset("site/js/simplebar.min.js")}}></script>
    <script src={{ asset("site/js/daterangepicker.js")}}></script>
    <script src={{ asset("site/js/jquery.stickOnScroll.js")}}></script>
    <script src={{ asset("site/js/tinycolor-min.js")}}></script>
    <script src={{ asset("site/js/config.js")}}></script>
    <script src={{ asset("site/js/d3.min.js")}}></script>
    <script src={{ asset("site/js/topojson.min.js")}}></script>
    <script src={{ asset("site/js/datamaps.all.min.js")}}></script>
    <script src={{ asset("site/js/datamaps-zoomto.js")}}></script>
    <script src={{ asset("site/js/datamaps.custom.js")}}></script>
    ...
    <script src={{ asset("site/js/apps.js")}}></script>
