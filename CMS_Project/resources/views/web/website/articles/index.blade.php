            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-12 text-center">
                        <h1 class="fw-bold mb-1" style="letter-spacing: 1px;">📝 Articles</h1>
                        <p class="text-muted fs-5">Browse and manage your articles</p>
                    </div>
                </div>
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-md-8 mb-2 mb-md-0">
                        <form action="{{ route('web.articles.index') }}" method="GET" class="d-flex">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('web.articles.create') }}" class="btn btn-success rounded-pill px-4 shadow-sm">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 shadow-lg h-100" style="border-radius: 1.5rem; transition: box-shadow 0.2s;">
                                <div class="card-body d-flex flex-column">
                                    <h5 class="card-title fw-bold text-gradient mb-1" style="background: linear-gradient(90deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                                        {{ $article->title }}
                                    </h5>
                                    ...
                                    <div class="d-flex justify-content-between gap-2 mt-auto">
                                        ...
                                        <form action="{{ route('web.articles.destroy', $article->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
